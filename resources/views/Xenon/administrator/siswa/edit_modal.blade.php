<div class="modal fade custom-width" id="modalEdit-{{ $siswa->id }}">
      ...
      <div class="modal-body">
        <form class="form-horizontal"  action="{{ route('admin.siswa.update', $siswa->id) }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group{{ $errors->has('nis') ? ' has-error' : '' }}">
            ...
            <div class="col-sm-10">
              <input id="name" name="nis" type="text" class="form-control" placeholder="Nomor Induk Siswa" value="{{ $siswa->nis }}" required>
          ...
          <div class="form-group{{ $errors->has('first_name') ? ' has-error' : '' }}">
            ...
            <div class="form-group{{ $errors->has('biaya') ? ' has-error' : '' }}">
              ...
              <div class="col-sm-10">
                <input id="biaya" name="biaya" type="text" class="form-control" placeholder="biaya" value="{{ $siswa->biaya }}" required>
