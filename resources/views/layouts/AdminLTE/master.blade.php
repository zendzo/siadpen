...
<div class="wrapper">
  ...
  <!-- Main Header -->
  @include('layouts.AdminLTE.header.header')

  <!-- =============================================== -->

  <!-- Left side column. contains the sidebar -->
  @include('layouts.AdminLTE.sidebar.sidebar')
  ...
  <div class="content-wrapper">
    ...
    @include('layouts.AdminLTE.content.content_header')
    <!-- /.content header -->
  ...
  <!-- Control Sidebar -->
  @include('layouts.AdminLTE.header.partials.control_sidebar')
  <!-- /.control-sidebar -->
...
@yield('script')
<!-- flash_message -->
@include('layouts.AdminLTE.flash.message')
